...
from experiments.dapo_math.common import build_student_messages, make_validators
...
def main() -> None:
    ...
    add_common_training_args(parser, output_dir_default="outputs/dapo_math/fipo")
